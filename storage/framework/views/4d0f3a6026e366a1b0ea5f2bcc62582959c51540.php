...
<div class="col-md-offset-2 col-md-8">
	...
	<div class="pull-right">
	<a href="/receipt/<?php echo e($receipt->id); ?>/edit" class="btn btn-primary">Edit Details</a>
		<form action="/receipt/<?php echo e($receipt->id); ?>" method="post" style="display: inline-block">
