...
<div class="col-md-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="pull-right"><a href="/suppliers/<?php echo e($pi->supplier->id); ?>"class="btn btn-primary">View Supplier</a></div>
		</div>
	</div>
			...
			<form action="/pi/<?php echo e($pi->id); ?>" method="post">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="brand" type="text" class="form-control input-sm" value="<?php echo e(old('brand')); ?>">
					</div>
				</div>
				<!-- model input -->
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="model" type="text" class="form-control input-sm" value="<?php echo e(old('model')); ?>">
					</div>
				</div>
				<!-- year input -->
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="year" type="text" class="form-control input-sm" value="<?php echo e(old('year')); ?>">
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input name="description" type="" class="form-control input-sm" value="<?php echo e(old('description')); ?>">
					</div>
				</div>
				<!-- quantity input -->
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="quantity" type="" class="form-control input-sm" value="<?php echo e(old('quantity')); ?>">
					</div>
				</div>
				<!-- price input -->
				<div class="col-md-3">
					<div class="form-group">
						...
						<input name="price" type="" class="form-control input-sm" value="<?php echo e(old('price')); ?>">
					</div>
				</div>
	...
	<div class="pull-right">
		<?php if(!$edit): ?>
		<a class="btn btn-primary" href="/pi/edit/<?php echo e($pi->id); ?>">Edit Invoice</a>
		<?php endif; ?>
